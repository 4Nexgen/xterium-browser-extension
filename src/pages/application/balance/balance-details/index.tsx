        ...
        <Table className="w-full">
          <TableBody>
            <TableRow className="flex flex-col gap-4 hover:bg-transparent hover:cursor-default p-6">
              <TableCell className="w-full h-12 flex items-center justify-center text-center bg-tablecell-detail rounded-lg relative border-2 border-primary dark:border-[#16514d] dark:border-border dark:bg-[#163F45]">
              ...
              <TableCell className="w-full h-12 flex items-center justify-center bg-tablecell-detail rounded-lg relative border-2 border-primary dark:border-[#16514d] dark:border-border dark:bg-[#163F45]">
                <div className="text-center">
                  <p className="text-lg font-bold text-purple">
