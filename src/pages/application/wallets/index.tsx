    ...
    <>
      <div className="py-4 flex flex-col justify-between h-full">
        ...
        <Drawer open={isAddWalletDrawerOpen} onOpenChange={setIsAddWalletDrawerOpen}>
          <DrawerContent>
            <DrawerHeader>
              <DrawerTitle className="border-b border-border-1/20 pb-4">{t("ADD NEW WALLET")}</DrawerTitle>
            </DrawerHeader>
        ...
        <Drawer
          ...
          <DrawerContent>
            <DrawerHeader>
              <DrawerTitle className="border-b border-border-1/20 pb-4">{t("EXPORT WALLET")}</DrawerTitle>
            </DrawerHeader>
            <IndexExportWallet
        ...
        <Drawer
          ...
          <DrawerContent>
            <DrawerHeader>
              <DrawerTitle className="border-b border-border-1/20 pb-4">{t("DELETE WALLET")}</DrawerTitle>
            </DrawerHeader>
            <IndexDeleteWallet
              selectedWallet={selectedWallet}
              handleCallbacks={callbackUpdates}
